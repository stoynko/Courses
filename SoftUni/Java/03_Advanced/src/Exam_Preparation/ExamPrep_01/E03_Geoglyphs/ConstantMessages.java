package Exam_Preparation.ExamPrep_01.E03_Geoglyphs;
...
public class ConstantMessages {
    ...
    public static final String NO_GEOGLYPHS_BY_TECHNIQUE = "There are no geoglyphs made by %s in this location.";
    ...
    public static final String NO_GEOGLYPHS_DISCOVERED = "No geoglyphs have yet been discovered in %s.";
}
