package _09_Workshop.common;

public final class SystemErrors {
    public static final String INVALID_USERNAME = "Error: Invalid username, make sure it's length is more than 4 symbols and contains at least 1 digit.";
    ...
    public static final String TRANSACTION_INITIATED_WITH_INVALID_AMOUNT = "Error: Invalid amount. Please input amounts up to 30,000 %s";
    ...
    public static final String NO_WALLET_FOUND_FOR_RECEIVER = "Error: You can't initiate a transfer to user %s as they do not have a Standard wallet";
