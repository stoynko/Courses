package _09_Workshop.services.imp;

import _09_Workshop.common.LogMessages;
import _09_Workshop.common.SystemErrors;
import _09_Workshop.core.UserSessionManager;
import _09_Workshop.entities.user.User;
import _09_Workshop.entities.wallet.DisposableWallet;
import _09_Workshop.entities.wallet.SavingsWallet;
import _09_Workshop.entities.wallet.StandardWallet;
import _09_Workshop.entities.wallet.Wallet;
import _09_Workshop.entities.wallet.WalletStatus;
import _09_Workshop.entities.wallet.WalletType;
import _09_Workshop.repositories.WalletRepository;
import _09_Workshop.services.WalletService;
...
public class WalletServiceImpl implements WalletService {
    ...
    public String getMyWallets() {
        validateActiveSession();
        User currentActiveUser = sessionManager.getActiveSession();
        List userWallets = walletRepository.getAll().stream().filter(w -> w.getOwnerId().equals(currentActiveUser.getId())).toList();
